...
The Degustujaca Istota is&nbsp;One Year Old!
She learned a&nbsp;lot and tested a&nbsp;lot in this year.
She met many great Chefs, sometimes personally, sometimes only through their work.

Below The Degustujaca Istota placed the best restaurants according to herself,
which she had the opportunity to visit last year.
The Degustujaca Istota also distinguished the best dishes that she ate in her  favorite restaurants.

## The Best Restaurants - Tasting Menu

List of the best restaurants according to the Degustujaca Istota, in alphabetical order, in which she enjoyed the tasting menu.
...
<img src="{{site.url}}/assets/img/posts/babel.jpg" alt="A piece of white fish with white sauce
 green drops of olive oil served on a black plate. Next to a rolled, grilled leaf of swiss chard."
height="200px" width="40px" />
</div></center>
<br />

#### Bialy krolik (Gdynia)/Poland

Chefs Marcin Popielarz and Rafal Koziorzemski.


The best course:
Cabbage soup cooked on smoked ribs with gherkin and macerated sturgeon.
<center><div style="width:65%">
<img src="{{site.url}}/assets/img/posts/bialykrolik.jpg" alt="In a white deep plate,
...
<center><div style="width:65%">
<img src="{{site.url}}/assets/img/posts/isto2019.jpg" alt="A mushroom piece of jelly covers the egg
...
<center><div style="width:65%">
<img src="{{site.url}}/assets/img/posts/n31.jpg" alt="A piece of squid, fried and cut in a checkered,
 next to fried shrimp with pieces of tomato on a blue background, brown on the sides."
height="200px" width="40px" />
</div></center>
<br />

#### Rozbrat20 (Warsaw)/Poland
...
<img src="{{site.url}}/assets/img/posts/rozbrat20.jpg" alt="Roasted livers, served on a brioche with
white sauce. Next to it there is mulberry and halves of a duck heart."
height="200px" width="40px" />
</div></center>
<br />

#### Villa Gardena (Katowice/Chorzow)/Poland
...
<center><div style="width:65%">
<img src="{{site.url}}/assets/img/posts/gardena.jpg" alt="A round piece of guinea fowl meat with toasted skin,
...
<center><div style="width:65%">
<img src="{{site.url}}/assets/img/posts/whiteone.jpg" alt="Two pieces of toasted scorzonera,
...
Here, the Degustujaca Istota collected restaurants where she ate the best dishes ordered from the menu. This does not mean that in the restaurants included in above the list
   she also didn't eat delicious dishes from the a la carte menu. The list order as above.

#### Amber Room (Warsaw)/Poland

The Chef, when the Degustujaca Istota visited the Amber Room resturant,
 was Lee Jones, while now the Chef is Kamil Rzechowicz.

  The best course: Duck/pak choi/sweet potatoe/young carrot.

<center><div style="width:65%">
<img src="{{site.url}}/assets/img/posts/amberroom.jpg" alt="Two slices of duck fillet, next to the sauce strips.
...
<center><div style="width:50%">
<img src="{{site.url}}/assets/img/posts/borze.jpg" alt="Two plates. One with fried livers
...
<center><div style="width:65%">
<img src="{{site.url}}/assets/img/posts/butchery.jpg" alt="Marbled carpaccio with
...
Chef Justyna Slupska Kartaczowska.


 The best course: Smoked eel/black caviar/black elderberry.

<center><div style="width:65%">
<img src="{{site.url}}/assets/img/posts/jadka.jpg" alt="Eel fillet surrounded by horseradish foam
...
<center><div style="width:50%">
<img src="{{site.url}}/assets/img/posts/muga.jpg" alt="A piece of octopus tentacle
...
<center><div style="width:65%">
<img src="{{site.url}}/assets/img/posts/sign.jpg" alt="Roasted liver on spreaded poppy seeds.
...
<center><div style="width:65%">
<img src="{{site.url}}/assets/img/posts/plado.jpg" alt="Goose leg on a light blue plate
...
<center><div style="width:50%">
<img src="{{site.url}}/assets/img/posts/vienna.jpg" alt="A large dumpling, placed on boiled, red
...
It was a beautiful year. The Degustujaca Istota thanks all Chefs and their teams and service in restaurants
for making her hobby so beautiful, for amazing experiences and for the works of art that gets on the plate.
 And for the New Year 2020, I wish it was even better than the previous one and that your work would be appreciated.
 To you reader, admiration and thanks that you wanted to look here and all the best for the New Year!
  Selfishly, the  Degustujaca Istota wants more time to describe the great things she ate,
   because many dishes worth immortalizing it is not described here yet.
   Many thanks for brilliant technical support of the blog,
  to the author [Writeonly.pl] and for the correction for Róża Majsterkiewicz. You are the best: D
